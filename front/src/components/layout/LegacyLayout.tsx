...
const navTree: NavNode[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { to: '/legacy/correcciones/cancelacion-tmimf',  icon: 'cancel',        label: 'Cancelación de TMIMF' },
      { to: '/legacy/correcciones/estimado-cosecha',   icon: 'eco',           label: 'Editar estimado cosecha' },
    ],
  },
  {
    id: 'reportes',
